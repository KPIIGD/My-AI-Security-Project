...
Latest result note: 2026-05-24 기준 `reports/release_gate_v0_2.json`의 5,000건 release gate는 pass 상태다. 본 문서의 데이터셋 구성은 초기 계획이며, 최신 실측 결과는 8.1절을 우선 참고한다.
...
### 8.1 2026-05-24 release gate result
