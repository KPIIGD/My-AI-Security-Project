...
| 검증 | 결과 | 근거 |
|---|---:|---|
| 집중 pytest | 139 passed | regex/context/policy/pipeline 회귀 테스트 |
| 전체 pytest | 1225 passed | `origin/main` 병합 뒤 전체 단위 테스트 |
...
| release gate | pass | 5,000건, `overall_recall=0.9432`, `overall_f1=0.8267` |
| release gate 핵심 recall | pass | high-risk structured recall 1.0, phone/email recall 1.0 |
| release gate 조사 경계 | pass | josa boundary accuracy 0.9984 |
| release gate raw PII 안전 | pass | raw PII leak 0, invalid offset 0 |
