...
| release gate actionable | pass | `actionable_precision=0.9975`, `actionable_recall=0.9036`, `actionable_f1=0.9482` |
| release gate 핵심 recall | pass | high-risk structured recall 1.0, phone/email recall 1.0 |
| release gate 조사 경계 | pass | boundary accuracy 0.9989 |
